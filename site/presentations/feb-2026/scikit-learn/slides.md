...
<div data-animate data-load="/assets/feb-2026/scikit-learn-objects.svg" crossorigin="anonymous">
<!-- {"setup": [
...
{"element": "#text1-2-1-3", "modifier": "attr", "parameters":  [ {"display": "none"} ]},
...
{"element": "#text1-2-1-3", "modifier": "attr", "parameters": [ {"class": "fragment appear", "data-fragment-index": "4"} ]}
 ]} -->
</div>
...
**click** so to use nemos basis objects with sklearn, we need to turn them into a transformer, which you can do in one of these two ways.

**click** and, if one of your basis objects accepts multidimensional inputs, we need a helper function, `set_input_shape`, so that we know how to split the inputs among the components
